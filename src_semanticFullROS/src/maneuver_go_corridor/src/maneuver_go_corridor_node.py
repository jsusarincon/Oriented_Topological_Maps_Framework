...
#	if "intersection" not in msg.modelName:
#		print "Collision!"
#		print msg.modelName, "hit ", msg.modelNameTouched
		#moveRobot(0,0)
		#time.sleep(2)
